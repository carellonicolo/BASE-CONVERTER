...
function CharacterDetailModal({ isOpen, onClose, character, details }: CharacterDetailModalProps) {
  ...
  return (
    ...
    >
      ...
      <div
        className="relative w-full max-w-2xl max-h-[90vh] overflow-hidden glass-morphism rounded-2xl shadow-2xl animate-scaleIn"
        onClick={(e) => e.stopPropagation()}
      >
        <div className="sticky top-0 z-10 bg-gradient-to-b from-slate-800/95 to-slate-800/80 backdrop-blur-xl border-b border-white/10 px-6 py-4">
        ...
        <div className="overflow-y-auto max-h-[calc(90vh-120px)] px-6 py-6 space-y-6 custom-scrollbar">
          <div className="space-y-4">
            <div className="glass-morphism rounded-xl p-4 border border-liquid-500/20">
              ...
              <p className="text-slate-200 leading-relaxed">{details.purpose}</p>
            </div>

            <div className="glass-morphism rounded-xl p-4 border border-blue-500/20">
              <h3 className="text-sm font-bold text-blue-300 uppercase tracking-wider mb-2">Dettagli Tecnici</h3>
              <p className="text-slate-200 leading-relaxed">{details.technicalDetails}</p>
            </div>

            <div className="glass-morphism rounded-xl p-4 border border-green-500/20">
              <h3 className="text-sm font-bold text-green-300 uppercase tracking-wider mb-2">Uso Moderno</h3>
              <p className="text-slate-200 leading-relaxed">{details.modernUsage}</p>
            </div>

            {details.examples && (
              <div className="glass-morphism rounded-xl p-4 border border-yellow-500/20">
        ...
        <div className="sticky bottom-0 bg-gradient-to-t from-slate-800/95 to-slate-800/80 backdrop-blur-xl border-t border-white/10 px-6 py-4">
          <button
            onClick={onClose}
